...
var AppBar = function (_Component) {
  ...
  _createClass(AppBar, [{
    ...
    value: function render() {
      ...
      var onLeftIconButtonClick = _props.onLeftIconButtonClick;
      var className = _props.className;
      var style = _props.style;
      var zDepth = _props.zDepth;
      var children = _props.children;

      var other = _objectWithoutProperties(_props, ['title', 'titleStyle', 'iconStyleLeft', 'iconStyleRight', 'onTitleTouchTap', 'showMenuIconButton', 'iconElementLeft', 'iconElementRight', 'iconClassNameLeft', 'iconClassNameRight', 'onLeftIconButtonClick', 'className', 'style', 'zDepth', 'children']);
...
AppBar.propTypes = {
   ...
   */
  onLeftIconButtonClick: _react.PropTypes.func,
  /**
   * Callback function for when the right icon is selected via a touch tap.
   *
   * @param {object} event TouchTap event targeting the right `IconButton`.
   */
  onRightIconButtonClick: _react.PropTypes.func,
  /**
