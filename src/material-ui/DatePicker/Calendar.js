  ...
  _createClass(Calendar, [{
    ...
    value: function yearSelector() {
      if (!this.props.disableYearSelection) return _react2.default.createElement(_CalendarYear2.default, {
        ...
        onClickYear: this.handleTouchTapYear,
    ...
    value: function render() {
      ...
      var onClickCancel = _props.onClickCancel;
      var onClickOk = _props.onClickOk;
...
Calendar.propTypes = {
  ...
  onClickCancel: _react.PropTypes.func,
  onClickDay: _react.PropTypes.func,
  onClickOk: _react.PropTypes.func,
