...
var DateDisplay = function (_Component) {
  ...
  _createClass(DateDisplay, [{
    ...
    value: function render() {
      ...
      var onClickMonthDay = _props.onClickMonthDay;
      var onClickYear = _props.onClickYear;
      var selectedDate = _props.selectedDate;
      var style = _props.style;
      var weekCount = _props.weekCount;

      var other = _objectWithoutProperties(_props, ['DateTimeFormat', 'disableYearSelection', 'locale', 'mode', 'monthDaySelected', 'onClickMonthDay', 'onClickYear', 'selectedDate', 'style', 'weekCount']);
...
DateDisplay.propTypes = {
  ...
  onClickMonthDay: _react.PropTypes.func,
  onClickYear: _react.PropTypes.func,
