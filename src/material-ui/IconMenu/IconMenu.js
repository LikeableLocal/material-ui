...
var IconMenu = function (_Component) {
  ...
  _createClass(IconMenu, [{
    ...
    value: function render() {
      ...
      var other = _objectWithoutProperties(_props, ['anchorOrigin', 'className', 'animated', 'animation', 'iconButtonElement', 'iconStyle', 'onItemTouchTap', 'onKeyboardFocus', 'onMouseDown', 'onMouseLeave', 'onMouseEnter', 'onMouseUp', 'onRequestChange', 'onClick', 'menuStyle', 'style', 'targetOrigin', 'touchTapCloseDelay', 'useLayerForClickAway']);
      ...
      var iconButton = _react2.default.cloneElement(iconButtonElement, {
        ...
        onClick: function onClick(event) {
          ...
          _this3.handleRequestClose('iconTap');          
          console.log('menu open')
          console.log('calling close now')
          }
